...
const API_KEY = "AKBZ7ONXIRSKRG8MHN8T";
const SECRET_KEY = "qf4niUWuCTdMlYhfFfJGAAaUdzQ8rywwyfJaG3Lm";
...
fetch(bars_url, {
  ...
  .then((response => {
      ...
      const data = response.bars.map(bars => (
          {
              open: bars.o,
                high: bars.h,
                low: bars.l,
                close: bars.c,
                time: Date.parse(bars.t) / 1000
          }
      ));
